...
#define SBC_DEC_MSBC_SYNC_WORD      0xAD
#define SBC_DEC_MSBC_SAMPLING_FREQ  SBC_sf16000
#define SBC_DEC_MSBC_CHANNEL_MODE   SBC_MONO
#define SBC_DEC_MSBC_ALLOC_METHOD   SBC_LOUDNESS
#define SBC_DEC_MSBC_NUM_SUB_BAND   SBC_SUB_BANDS_8
#define SBC_DEC_MSBC_NUM_BLOCKS     15
#define SBC_DEC_MSBC_BITPOOL        26

    /* decode mode */
#define SBC_DEC_MODE_SBC            0
#define SBC_DEC_MODE_MSBC           1
#define SBC_DEC_MODE_MSBC_BLE       2   /* include only one reserved byte */
    UINT8  decodeMode;
#endif
}SBC_DEC_PARAMS;
