...
/* exclude/include mSBC code for BLE audio */
#ifndef BLE_AUDIO_INCLUDED
...
typedef struct SBC_ENC_PARAMS_TAG
{
    ...
    /* This buffers must align on 32 bits -> keep it behind a 32 bit declaration */
    SINT32 s32DCTY[DCT_BUF_SIZE];
...
#if (defined BLE_AUDIO_INCLUDED ) && (BLE_AUDIO_INCLUDED == TRUE)
    /* mSBC fixed configurations */
#define SBC_ENC_MSBC_SYNC_WORD      0xAD
#define SBC_ENC_MSBC_SAMPLING_FREQ  SBC_sf16000
#define SBC_ENC_MSBC_CHANNEL_MODE   SBC_MONO
#define SBC_ENC_MSBC_ALLOC_METHOD   SBC_LOUDNESS
#define SBC_ENC_MSBC_NUM_SUB_BAND   SUB_BANDS_8
#define SBC_ENC_MSBC_NUM_BLOCKS     15
#define SBC_ENC_MSBC_BITPOOL        26

    /* encode mode */
#define SBC_ENC_MODE_SBC            0
#define SBC_ENC_MODE_MSBC           1
#define SBC_ENC_MODE_MSBC_BLE       2   /* include only one reserved byte */
    UINT8  encodeMode;
#endif
}SBC_ENC_PARAMS;
