...
enum
{
    ...
    APP_DG_MENU_GET_SERVICE_NAME,
    APP_DG_MENU_GET_SERVICE_LIST,
    APP_DG_MENU_DISC_AND_GET_SRV_LIST,
    APP_DG_MENU_READ,
...
void app_dg_display_main_menu(void)
{
    ...
    printf("    %d => Get Profile Service Name\n", APP_DG_MENU_GET_SERVICE_NAME);
    printf("    %d => Get Profile Service List\n", APP_DG_MENU_GET_SERVICE_LIST);
    printf("    %d => Discovery & Get Service List\n", APP_DG_MENU_DISC_AND_GET_SRV_LIST);
...
int main(int argc, char **argv)
{
    ...
    do
    {
        ...
        case APP_DG_MENU_GET_SERVICE_NAME:
            app_dg_get_service_name();
            break;

        case APP_DG_MENU_GET_SERVICE_LIST:
            app_dg_get_service_list();
            break;

        case APP_DG_MENU_DISC_AND_GET_SRV_LIST:
            app_dg_disc_and_get_service_list();
            break;
