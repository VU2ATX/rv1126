...
export class IntrusionDetectionComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    ...
    this.cfg.getStreamURLInterface()
    .subscribe(
      ...
      err => {
        this.logger.error(err, 'ngOnInit:getStreamURLInterface:');
        this.src = null;
