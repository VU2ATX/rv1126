...
#define OSD_RESOURCE_PATH MEDIASERVER_CONF_PREFIX "/usr/share/aiserver/"
#else
#define OSD_RESOURCE_PATH "/oem/usr/share/aiserver/"
#endif
...
enum {
  ...
  OSD_REGION_ID_LAYER3, // ID_TEXT0
  OSD_REGION_ID_LAYER4, // ID_MASK0  (1-2-3)
  OSD_REGION_ID_LAYER5, // ID_TEXT1  (2)
  OSD_REGION_ID_LAYER6, // ID_TEXT3-4
...
public:
  ...
  void SetOsdRegion(int region_id, std::map<std::string, std::string> map);
