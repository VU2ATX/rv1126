...
public:
  ...
  void SyncSchedulesConfig() { schedules_manager_->SyncSchedulesConfig(); }
  int MDTriggerEnabled() { return schedules_manager_->MDTriggerEnabled(); }
  void MDEventCountAdd() { schedules_manager_->MDEventCountAdd(); }
#endif
