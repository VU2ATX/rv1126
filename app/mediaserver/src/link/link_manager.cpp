  ...
  if (audio_pipe) {
    ...
    if (link_flow) {
      ...
      if (enc_flow_unit) {
        ...
        else if (enc_output_data_type.find("aac") != std::string::npos)
          FillMediaParam(MEDIA_PARAM_AUDIO_FMT, MEDIA_PARAM_AUDIO_FORMAT_AAC);
        else
        ...
        if (enc_output_data_type.find("s16") != std::string::npos)
          FillMediaParam(MEDIA_PARAM_AUDIO_SAMPLE_BITS,
                         MEDIA_PARAM_AUDIO_SAMPLE_BITS_16BIT);
        else if (enc_output_data_type.find("s8") != std::string::npos)
          FillMediaParam(MEDIA_PARAM_AUDIO_SAMPLE_BITS,
